...
class QRRSBlock {
  ...
  static getRsBlockTable(typeNumber: number, errorCorrectLevel: ErrorCorrectLevel): number[] | undefined {
  ...
  static getRSBlocks(typeNumber: number, errorCorrectLevel: ErrorCorrectLevel): QRRSBlock[] {
